...
DB = "kbv4nd"  # replace with your UVA computing ID / database name
...
@app.get("/")  # zone apex
def zone_apex():
    return {"Hello": "World Wide Web. What's up Cole"}

#app is the fast API - see above (Cole note); We are making the thing below in class 3/19
...
def multiply_me(number1: int, number2: int):
